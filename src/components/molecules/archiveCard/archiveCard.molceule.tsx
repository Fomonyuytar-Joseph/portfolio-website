...
const ArchiveCard: React.FC<ArchiveCardProps> = ({
  ...
  return (
    <div
      className="w-full flex flex-col items-start  bg-primary-light-navy rounded transition-transform duration-300 xl:hover:-translate-y-3 hover:-translate-x-3 cursor-pointer"
      style={{
